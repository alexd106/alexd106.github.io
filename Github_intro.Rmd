...
```{r mod1, echo=FALSE, out.width="60%", fig.align="center"}
...
Before you commit your changes notice the status of `first_doc.pdf` has changed from untracked to added (A). You can also check out the changes you have made to the `first_doc.Rmd` by clicking on the file name in the lefthand pane. The pane at the bottom provides a useful summary of the changes. Lines that have been deleted are highlighted in red and lines that have been added are highlighted in green. Once you're happy you understand this, commit these changes by writing a suitable commit message and click on the 'Commit' button.

\  

```{r mod4, echo=FALSE, out.width="60%", fig.align="center"}

...
Following our workflow, we now need to **stage** these files. To do this tick the boxes under the 'Staged' column for all files. After you have staged the files the next step is to **commit** the files. This is done by clicking on the 'Commit' button.

\  

```{r rm3, echo=FALSE, out.width="60%", fig.align="center"}
knitr::include_graphics(path = "images/first_Rmd3.png")
```

\  

Which will bring up an new 'Review changes' window

...
OK, lets go through an example to help clarify this workfow. Open up the `first_repo.Rproj` file you created in Option 1 in RStudio. Let's create an R markdown document by clicking on the `File` -> `New File` -> `R markdown` menu (remember from the [R markdown tutorial](Rmarkdown_intro.html)?).  

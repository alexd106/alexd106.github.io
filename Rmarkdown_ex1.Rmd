...
You will also need to download [this image](images/squid_anatomy.jpg) and save it in the same directory as your R markdown document (right click and then choose `save image as...` or similar). You will embed this image after your text in your R markdown document.

...
Text is running off the page when I render a pdf document

Add a global_options argument at the start of your .Rmd file:

```{r global_options2, include = FALSE, eval=FALSE}

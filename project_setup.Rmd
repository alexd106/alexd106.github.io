...
In my working directory I have the following directories: 
  ...
  - **output** - Outputs from my R scripts such as plots, HTML files and data summaries are saved in this directory. This helps me and others to distinguish what files are outputs and which are source files.  
